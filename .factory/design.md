...
- `public/assets/proofing-table.webp`: original generated hero illustration, used to introduce source-to-structure comparison without implying automatic OCR. Responsive WebP, explicit dimensions, under 300KB.
